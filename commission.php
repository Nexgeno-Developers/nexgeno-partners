<?php
$pageTitle = 'Commission Structure | Nexgeno Partners';
$activePage = 'commission';
$compactHeroWrap = true;
$bodyPageClass = 'page-commission';
$heroWrapExtraClass = 'hero-wrap-commission';
include 'header.php';
?>
      ...
      <div class="row g-4 justify-content-center">
        <div class="col-sm-6 col-lg-3">
          <article class="commission-feature-card text-center">
            <span class="commission-feature-icon"><i class="bi bi-graph-up-arrow"></i></span>
            <h3>High Commission Rates</h3>
            <p>Earn up to 25% on every project you refer.</p>
          </article>
        </div>
        <div class="col-sm-6 col-lg-3">
          <article class="commission-feature-card text-center">
            <span class="commission-feature-icon"><i class="bi bi-arrow-repeat"></i></span>
            <h3>Recurring Income</h3>
            <p>Earn monthly on SEO, hosting, and maintenance services.</p>
          </article>
        </div>
        <div class="col-sm-6 col-lg-3">
          <article class="commission-feature-card text-center">
            <span class="commission-feature-icon"><i class="bi bi-calendar3"></i></span>
            <h3>Fast Payouts</h3>
            <p>Commission released within 7 working days of payment.</p>
          </article>
        </div>
        <div class="col-sm-6 col-lg-3">
          <article class="commission-feature-card text-center">
            <span class="commission-feature-icon"><i class="bi bi-calculator"></i></span>
            <h3>Transparent Tracking</h3>
            <p>Clear visibility into your referrals and earnings.</p>
          </article>
        </div>
      </div>
    </div>
      ...
      <div class="commission-payment-card">
        <ul class="commission-payment-list">
          <li>
            ...
            <span>Commission is calculated on the net project value</span>
          </li>
          <li>
            <span class="commission-payment-check" aria-hidden="true"><i class="bi bi-check-lg"></i></span>
            <span>Payment released within 7 working days after client payment</span>
          </li>
          <li>
            <span class="commission-payment-check" aria-hidden="true"><i class="bi bi-check-lg"></i></span>
            <span>Recurring commissions paid monthly on active subscriptions</span>
          </li>
          <li>
            <span class="commission-payment-check" aria-hidden="true"><i class="bi bi-check-lg"></i></span>
            <span>Multiple payment options: Bank Transfer, UPI, PayPal</span>
          </li>
          <li>
            <span class="commission-payment-check" aria-hidden="true"><i class="bi bi-check-lg"></i></span>
            <span>Monthly statement provided with all earnings details</span>
          </li>
          <li>
            <span class="commission-payment-check" aria-hidden="true"><i class="bi bi-check-lg"></i></span>
  ...
  <section class="commission-cta-banner" aria-labelledby="commission-cta-heading">
    <div class="container">
      <div class="commission-cta-inner">
